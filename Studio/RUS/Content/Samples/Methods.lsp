...
(defun PopulateManipulationTabFields (/ curPos tabSize)
    ...
    (dcl_Control_SetText Methods_DemoMethods_BottomFromBottom
                         (itoa BottomFromBottom)
    )
    (dcl_Control_SetText Methods_DemoMethods_RightFromRight
                         (itoa RightFromRight)
    )
...
(defun c:DemoMethods_TabControl_Changed (nSelIndex       /
                                         BottomFromBottom
    ...
    (if (= nSelIndex 1) ;_ Sliders Tab
        (progn (dcl_Control_SetValue
                   Methods_DemoMethods_AngleSlider1
                   (atoi (dcl_Control_GetText Methods_DemoMethods_AngleBox))
               )
               (dcl_Control_SetValue
                   Methods_DemoMethods_ScrollBar1
                   (atoi (dcl_Control_GetText Methods_DemoMethods_VScrollLabel))
               )
               (dcl_Control_SetValue
                   Methods_DemoMethods_SliderBar1
                   (atoi (dcl_Control_GetText Methods_DemoMethods_VSliderLabel))
               )
               (dcl_Control_SetValue
                   Methods_DemoMethods_ScrollBar2
                   (atoi (dcl_Control_GetText Methods_DemoMethods_HScrollLabel))
               )
               (dcl_Control_SetValue
                   Methods_DemoMethods_SliderBar2
                   (atoi (dcl_Control_GetText Methods_DemoMethods_HSliderLabel))
               )
               (dcl_Control_SetText
                   Methods_DemoMethods_SpinnedBox
                   (itoa (dcl_Control_GetValue Methods_DemoMethods_SpinButton1))
               )
        )
    ) ;_ if
...
(defun c:DemoMethods_DrawWrappedText_Clicked ()
    ...
    (dcl_PictureBox_DrawWrappedText
        Methods_DemoMethods_PictureBox
        '((10
           10
           220
           -19
...
(defun c:DemoMethods_LoadPictureFile_Clicked (/ sFileName)
    ...
    (if (/= sFileName nil)
        (dcl_PictureBox_LoadPictureFile Methods_DemoMethods_PictureBox
                                        sFileName
        )
...
(defun c:DemoMethods_LeftBox_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetLeftFromRight Methods_DemoMethods_SampleControl
...
(defun c:DemoMethods_TopBox_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetTopFromBottom Methods_DemoMethods_SampleControl
...
(defun c:DemoMethods_WidthBox_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetRightFromRight
        Methods_DemoMethods_SampleControl
...
(defun c:DemoMethods_VisibleCheck_Clicked (nValue /)
    (dcl_Control_SetVisible Methods_DemoMethods_SampleControl
                            (not (zerop nValue))
    )
)
...
(defun c:DemoMethods_BottomCheck_Clicked (nValue /)
    (dcl_Control_SetUseBottomFromBottom Methods_DemoMethods_SampleControl
                                        nValue
    )
)
...
(defun c:DemoMethods_LeftFromRight_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetLeft Methods_DemoMethods_SampleControl
                         (setq nVal (- (car tabSize) nVal))
    )
...
(defun c:DemoMethods_TopFromBottom_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetTop Methods_DemoMethods_SampleControl
                        (setq nVal (- (cadr tabSize) nVal))
    )
...
(defun c:DemoMethods_RightFromRight_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetWidth Methods_DemoMethods_SampleControl
                          (setq nVal (- (car tabSize) nVal (car curPos)))
    )
...
(defun c:DemoMethods_BottomFromBottom_EditChanged (sText / curPos tabSize nVal)
    ...
    (dcl_Control_SetHeight Methods_DemoMethods_SampleControl
                           (setq nVal (- (cadr tabSize) nVal (cadr curPos)))
    )
