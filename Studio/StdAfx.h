...
#include <xtree> //must be included before redefining 'new'
#ifdef _DEBUG
...
extern HMODULE appLocalResModule(void);

class CLocalResourceModuleOverride
{
	HMODULE m_hmodOriginal;
	bool mbMustRestore;
public:
	CLocalResourceModuleOverride()
