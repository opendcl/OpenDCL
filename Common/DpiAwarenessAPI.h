...
__if_not_exists(PROCESS_DPI_AWARENESS)
{
...
__if_not_exists(MONITOR_DPI_TYPE)
{
...
__if_not_exists(DIALOG_DPI_CHANGE_BEHAVIORS)
{
...
__if_not_exists(DIALOG_CONTROL_DPI_CHANGE_BEHAVIORS)
{
