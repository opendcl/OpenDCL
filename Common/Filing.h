...
//void writeBOOL(FILE* pFile, BOOL b);
//void writeString(FILE* pFile, CStringA s);
...
//void writeImage(FILE* pFile, const CStringA &fileName, const CImage &img);
//void writeImageList(FILE* pFile, const CStringA &fileName, const CImageList &l);
