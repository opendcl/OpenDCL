...
public:
	...
	CPictureObject	*m_pPressedPicture;
	...
	void SetPressedPictureID(int nPictureID);
...
private:
	...
	void FreePressedResources(BOOL bCheckForNULL);
	void FreeUnPressedResources(BOOL bCheckForNULL);
public:
	void InitToolTip();

	HCURSOR		m_hCursor;			// Handle to cursor
	CPPToolTip  m_ToolTip;			// Tooltip
