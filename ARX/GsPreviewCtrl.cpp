...
{	
	...
	m_pDocToModReactor = new CAcadDocReactor(NULL, this);
	...
	// m_pLog = new CStdioFile("c:BlockView.Log", CFile::modeCreate|CFile::modeNoTruncate|CFile::modeWrite);
...
BOOL CGsPreviewCtrl::DisplayHatchPattern(CString sPattern)
{
	...
	long lClr = m_ArxControl->GetLngProperty(nForeColor);
	AcCmColor clr;
