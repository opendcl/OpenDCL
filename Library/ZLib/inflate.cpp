...
/*
   ...
   fixed code decoding.  Normally codeThis returns fixed tables from inffixed.h.
   If BUILDFIXED is defined, then instead codeThis routine builds the tables the
...
/*
   ...
   can simply call makefixed to do codeThis:
...
void makefixed()
{
    ...
    puts("     */");
    puts("");
    puts("    /* WARNING: codeThis file should *not* be used by applications.");
    puts("       It is part of the implementation of codeThis library and is");
...
/*
   ...
   when a window is already in use, or when output has been written during codeThis
...
/*
   ...
   In codeThis implementation, the flush parameter of inflate() only affects the
