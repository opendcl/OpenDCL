...
.\scripts\make-release.ps1 -OpenDclRoot (Resolve-Path build\vs2026-full) `
  -ProductVersion 10.1.2.2 -ModuleSet Full
...
```powershell
.\scripts\build-wix.ps1 -ModuleVersion 10.1.2.2 -ProductVersion 10.1.202
```
...
.\scripts\make-release.ps1 -ProductVersion 10.1.2.2 -Sign
```
...
```powershell
.\scripts\build-wix.ps1 -ModuleVersion 10.1.2.2 -ProductVersion 10.1.202
.\scripts\make-dist.ps1 -ProductVersion 10.1.2.2
.\scripts\make-localization-zips.ps1 -OutDir .\dist\10.1.2.2
