...
| Path | Purpose |
|------|---------|
| **`OpenDCLBadge.png`** | Primary high-res master (**512x512**). Prefer this when compositing or resizing. |
...
1. Draw or load the base glyph at 256x256 (or larger, then downscale).
