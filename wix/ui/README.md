...
| File | Pixels | Notes |
| --- | --- | --- |
| `WixUIBanner.bmp` | 493x58 | Logo on the **right** at native size (no upscaling). Left remains blank for captions. |
| `WixUIDialog.bmp` | 493x312 | Left ~164px CAD-themed art; right pure white for text. |
