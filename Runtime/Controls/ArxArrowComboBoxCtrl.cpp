...
BEGIN_MESSAGE_MAP(CArxArrowComboBoxCtrl, CAcUiArrowHeadComboBox)
	...
	ON_WM_KILLFOCUS()
	ON_WM_MOUSEMOVE()
	ON_CONTROL_REFLECT(CBN_SELCHANGE, &CArxArrowComboBoxCtrl::OnCbnSelchange)
	ON_CONTROL_REFLECT(CBN_DROPDOWN, &CArxArrowComboBoxCtrl::OnCbnDropdown)
	ON_MESSAGE(CB_ADDSTRING, &CArxArrowComboBoxCtrl::OnModifyContent)
	ON_MESSAGE(CB_DELETESTRING, &CArxArrowComboBoxCtrl::OnModifyContent)
	ON_MESSAGE(CB_DIR, &CArxArrowComboBoxCtrl::OnModifyContent)
	ON_MESSAGE(CB_INSERTSTRING, &CArxArrowComboBoxCtrl::OnModifyContent)
	ON_MESSAGE(CB_SETITEMDATA, &CArxArrowComboBoxCtrl::OnModifyContent)
	ON_MESSAGE(CB_RESETCONTENT, &CArxArrowComboBoxCtrl::OnResetContent)
END_MESSAGE_MAP()
...
LRESULT CArxArrowComboBoxCtrl::OnModifyContent( WPARAM wParam, LPARAM lParam )
{
...
LRESULT CArxArrowComboBoxCtrl::OnResetContent( WPARAM wParam, LPARAM lParam )
{
	CString sSelection;
