...
{
	int nIndex = 0;
	CArxBlockViewCtrl *pControl = (CArxBlockViewCtrl*)GetControlPointer(CtlBlockView, sBlockView::GetViewInfo, &nIndex);
...
ADSRESULT BlockView::SetView()
{
	...
	CArxBlockViewCtrl *pControl = (CArxBlockViewCtrl*)pArxObject->GetWindow();
