// Methods_Calendar.cpp : implementation file
//
...
ADSRESULT Calendar::SetCurSel()
{
	struct resbuf *pArgs =acedGetArgs () ;

	CDialogControl* pDlgControl = NULL;
	if (!GetDlgControlArgument (pArgs, pDlgControl, CtlCalendar))
...
ADSRESULT Calendar::GetRangeStart()
{
	struct resbuf *pArgs =acedGetArgs () ;
...
ADSRESULT Calendar::GetRangeEnd()
{
	struct resbuf *pArgs =acedGetArgs () ;
...
ADSRESULT Calendar::GetMonthRangeStart()
{
	struct resbuf *pArgs =acedGetArgs () ;
...
ADSRESULT Calendar::GetMonthRangeEnd()
{
	struct resbuf *pArgs =acedGetArgs () ;
...
ADSRESULT Calendar::SetSelRange()
{
	struct resbuf *pArgs =acedGetArgs () ;
...
ADSRESULT Calendar::GetSelRangeStart()
{
	struct resbuf *pArgs =acedGetArgs () ;
...
ADSRESULT Calendar::GetSelRangeEnd()
{
	struct resbuf *pArgs =acedGetArgs () ;
